...
export let DATA = [
  ...
  },
  {
    ...
    created_at: "2019-01-04 18:30:20",
  },
  {
    user: "sundar",
    message: "code now! #work #hard",
    created_at: "2019-01-05 07:30:20",
  },
  {
    user: "steve",
    message: "Stay hungry, and stay foolish",
    created_at: "2015-01-03 12:30:20",
  },
  {
    user: "tim",
...
export const randomUser = ["ingikim", "satya", "sundar", "steve", "tim", "jeff"];
...
//랜덤트윗 데이터에서 뽑아낼 랜덤숫자 생성
const getRandomInt = (min, max) => {
  return Math.floor(Math.random() * (max - min)) + min;
};

//랜덤숫자에 해당하는 랜덤트윗을 객체 형태로 만들기
export const generateNewTweet = () => {
  let tweet = {};
  const date = new Date();
...
//숫자 1자리수일 때 0 붙여주기 -> format에서 사용됨
